from main import calculate_score, queue_value_billion_toman, format_report_line
...
def test_line_shows_signed_queue_value():
    assert format_report_line(1, {"symbol": "فولاد", "score": 5.0, "queue_value": 125, "queue_side": "buy"}) == "1. فولاد | +5.0 | +125 میلیارد"
    assert format_report_line(2, {"symbol": "خودرو", "score": -4.2, "queue_value": 87, "queue_side": "sell"}) == "2. خودرو | -4.2 | -87 میلیارد"
